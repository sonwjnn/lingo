...
export const Card = ({
  ...
  return (
    ...
    >
      {audio}
      {imageSrc && (
        <div className="relative mb-4 aspect-square max-h-80 w-full lg:max-h-[150px]">
      ...
      >
        ...
        <div
          className={cn(
            'text-neutral-400lg:text-[15px] flex h-[20px] w-[20px] items-center justify-center rounded-lg border-2 text-xs font-semibold lg:h-[30px] lg:w-[30px]',
